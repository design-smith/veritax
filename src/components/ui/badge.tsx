...
const badgeVariants = cva(
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden whitespace-nowrap rounded-[var(--radius-xs)] border px-1.5 py-0.5 text-xs font-semibold leading-4 tracking-normal transition-[background-color,border-color,color,box-shadow] focus:outline-none focus:ring-2 focus:ring-ring/35 [&>svg]:size-3",
  {
    variants: {
      variant: {
        ...
        caution: "border-transparent bg-caution-soft text-caution-soft-foreground",
